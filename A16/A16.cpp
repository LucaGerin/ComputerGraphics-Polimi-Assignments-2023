...
class A16 : public BaseProject {
	...
	void localInit() {
		...
		/* A16 */
		/* Init the new Data (DESCRIPTOR?) Set Layout */
		DSLVColor.init(this, {
					{0, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, VK_SHADER_STAGE_ALL_GRAPHICS}
			});
			...
			{ { 0, sizeof(VertexVColor), VK_VERTEX_INPUT_RATE_VERTEX } },
				{
					...
					//{ 0, 0, VK_FORMAT_R32G32_SFLOAT, offsetof(VertexVColor, pos), sizeof(glm::vec2), OTHER},
	...
	void pipelinesAndDescriptorSetsInit() {
		...
		/* A16 */
		/* Define the data DESCRIPTOR? set for the room */
